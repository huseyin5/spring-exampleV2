...
import com.haydikodlayalim.springdatajpapostgresql.controller.KisiController;
...
public class KisiControllerTest {
    ...
    void whenValidInput_thenReturns200() throws Exception {
        // given
        KisiDto kisi = KisiDto.builder().adi("huseyin").soyadi("mutlu").build();
        ...
        assertThat(captor.getValue().getAdi()).isEqualTo("huseyin");
        assertThat(captor.getValue().getSoyadi()).isEqualTo("mutlu");
    ...
    void whenInvalidInput_thenReturns400() throws Exception {
        // given
        KisiDto kisi = KisiDto.builder().soyadi("mutlu").build();
